...
using FileBrowser.Core.Actions;
using FileBrowser.Utils;
using FileBrowser.Views.FilePicking;
...
namespace FileBrowser.Views {
    ...
    public class WindowEx : Window {
        ...
        public static readonly DependencyProperty CanCloseWithEscapeKeyProperty = 
            DependencyProperty.Register(
                nameof(CanCloseWithEscapeKey), 
                typeof(bool), 
                typeof(WindowEx), 
