namespace FileBrowser.Core.Views.Dialogs.UserInputs {
    public class DoubleInputViewModel : BaseConfirmableDialogViewModel {
        ...
        public static void ClearInputUnsafe(DoubleInputViewModel viewModel) {
            viewModel.inputA = null;
            viewModel.inputB = null;
        }
    }
}